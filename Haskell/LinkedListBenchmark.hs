...
benchmark list1 list2 list3 list4 list5 list6 = defaultMain
  ...
  , bgroup
    "Linked List Filter"
    [ bench "10 elements" $ whnf (LL.filter isOdd) list1
    , bench "100 elements" $ whnf (LL.filter isOdd) list2
    , bench "1 000 elements" $ whnf (LL.filter isOdd) list3
    , bench "10 000 elements" $ whnf (LL.filter isOdd) list4
    , bench "100 000 elements" $ whnf (LL.filter isOdd) list5
    , bench "1 000 000 elements" $ whnf (LL.filter isOdd) list6
    ]
  , bgroup
    "Linked List Reduce"
